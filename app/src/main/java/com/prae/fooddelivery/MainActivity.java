...
public class MainActivity extends AppCompatActivity {
    ...
    public void signInClick(View view){
        ...
        String email = ((TextView)findViewById(R.id.editText2)).getText().toString();
        String password = ((TextView)findViewById(R.id.editText3)).getText().toString();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent prae = new Intent(MainActivity.this,Main2Activity.class);
                            startActivity(prae);
                        } else {
